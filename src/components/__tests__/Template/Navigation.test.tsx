...
describe('Navigation', () => {
  ...
  it('renders the logo link to home', () => {
    render(<Navigation />);
    const logo = screen.getByRole('link', { name: /sa/i });
  ...
  it('renders the nav actions area', () => {
    render(<Navigation />);

    expect(document.querySelector('.nav-actions')).toBeInTheDocument();
  });

  it('does not render the theme toggle while light mode is unfinished', () => {
    render(<Navigation />);
